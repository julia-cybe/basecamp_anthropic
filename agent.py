...
TONE_ADDENDUM = "if the user signals that he has given up on resolution and is threatening with an action, escalate to a human"                       # ✏️ Build 4, step 4.1, intelligence lane
